...
def _portfolio_weights_checker(desired_portfolio: Portfolio) -> bool:
    ...
    # Secondly, check weights as a portfolio and set portfolio status as approved if successful
    # TODO : add contextual exception raising to inform user of incorrect piece
    if _total_portfolio_weights_checker(desired_portfolio):
        # TODO: Change this implementation as is a check function but is performing a manipulation
